                    ...
                    <form action="{{url('invoices/update')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control">
                                    <option value="{{ $invoice->products->id }}">{{ $invoice->products->product_name }} </option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3" value="{{ $invoice->note }}"> {{ $invoice->note }} </textarea>
                            </div>
                        </div><br>
