            ...
            <div class="card-header pb-0">
                ...
                <div class="row row-xs wd-xl-80p">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <a href="invoices/create" class="btn btn-primary-gradient btn-block"><i class="fas fa-plus"></i>
                            إضافة فاتورة</a>
                    </div>
                    @endcan
                    ...
                    <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                        <a href="export_invoices" class="btn btn-success-gradient btn-block"> تصدير الفواتير</a>
                    </div>
                    @endcan
                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td> <a href="/invoiceDetails/{{ $invoice->id }}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item text-primary"
                                                    href="{{ url('invoices/edit') }}/{{ $invoice->id }}">
                                                ...
                                                <a class="dropdown-item text-success"
                                                    href="{{ url('invoices/change_payment') }}/{{ $invoice->id }}">
                                                ...
                                                <a class="dropdown-item text-danger" data-effect="effect-scale"
                                                    data-id="{{ $invoice->id }}" data-delete_type="force_delete"
                                                ...
                                                <a class="dropdown-item text-secondary" data-effect="effect-scale"
                                                    data-id="{{ $invoice->id }}" data-delete_type="soft_delete"
                                                    data-toggle="modal" href="#softdelete" title="حذف"><i
                                                ...
                                                <a class="dropdown-item text-info"
                                                    href="{{ url('invoices/print_invoice') }}/{{ $invoice->id }}">
