        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'paied_invoices')) }}">الفواتير المدفوعة</a></li>
                    @endcan

                    @can('الفواتير الغير مدفوعة')
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaied_invoices')) }}">الفواتير الغير المدفوعة</a></li>
                    @endcan

                    @can('الفواتير المدفوعة جزئيا')
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'partial_paied_invoices')) }}">الفواتير المدفوعة جزئياً</a></li>
                    @endcan

                    @can('ارشيف الفواتير')
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'InvoicesArchive')) }}">الأرشيف</a></li>
                    @endcan
            ...
            @endcan
                <ul class="slide-menu">
                    ...
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'users_reports')) }}">تقارير العملاء</a></li>
                    @endcan
                </ul>
            </li>
            @can('المستخدمين')
